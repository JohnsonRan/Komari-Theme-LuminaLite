...
// 要展示的界面：桌面亮/暗首页、桌面暗色详情、桌面亮色流量、移动首页、移动详情。
const FRAMES = [
  ...
  { key: "mobile-inst", label: "移动端详情", url: `${DEV}/instance/tokyo-edge-01?mock=1`, w: 390, h: 780, dark: false },
];
  ...
  return `<!doctype html><html><head><meta charset="utf-8"/><style>
    * { box-sizing: border-box; margin: 0; }
    ...
    <header>
      ...
      <p>亮 / 暗双主题 · 四种节点视图 · 详情分栏与图表 · 移动端适配</p>
    </header>
